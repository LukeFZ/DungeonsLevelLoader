...
struct MainWindow
{
    ...
    void Draw(const char* title, bool* p_open)
    {
        ...
        if (!ImGui::Begin("Custom Level List"))
        {
            ImGui::End();
            return;
        }
...
DWORD WINAPI UIThreadFunction(LPVOID lpParam) {
    ...
    ::RegisterClassEx(&wc);
    HWND hwnd = ::CreateWindow(wc.lpszClassName, _T("CustomLevels"), WS_OVERLAPPEDWINDOW, 100, 100, 640, 480, NULL, NULL, wc.hInstance, NULL);
